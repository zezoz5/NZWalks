...
{
    /// <inheritdoc />
    public partial class SeedRegionsAndDifficultyData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3f0a497e-1afe-4a76-80ca-b1ad5b736a21"), "Medium" },
                    { new Guid("cf61424f-a3fd-48d0-a955-faac71c3315b"), "Easy" },
                    { new Guid("fc788976-8609-4805-8963-451b260da7c1"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("3f0a497e-1afe-4a76-80ca-b1ad5b736a21"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("cf61424f-a3fd-48d0-a955-faac71c3315b"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("fc788976-8609-4805-8963-451b260da7c1"));
